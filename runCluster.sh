...
java -Dip4.addr=localhost -Xms8g -Xmx8g -classpath "./src/main/resources:${CLASSPATH}:./the-bank/target/the-bank-1.0-SNAPSHOT.jar" com.theyawns.launcher.ClusterMember
